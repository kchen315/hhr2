...
# sbatch -p general -N 1 --mem=16g -n 1 -t 168:00:00 --wrap="python3 vid_gen.py"

sbatch -N 1 -n 1 -c 1 -p volta-gpu --mem=128g -t 168:00:00 --qos gpu_access --gres=gpu:1 --mail-user=kevin.chen@unchealth.unc.edu --wrap="python3 vit_fe_model.py"